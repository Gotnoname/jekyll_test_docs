...
| locale               | [spraak]({{site.baseurl}}/docs/resources/begrep/felles/spraak), se under for hvilke språk som er støttet                                                      | 0..1         |
...
[sikkerhetsnivaa]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/begrep/sikkerhetsnivaa) slik:

| AuthnContextClassRef                                              | [sikkerhetsnivaa]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/begrep/sikkerhetsnivaa) |
| --- | --- |
