...
|---|---|
| Term          | {{page.title}} |
| Definisjon    | Respons sendt tilbake til Virksomhet som svar på [HentPersonerForespoersel]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/HentPersonerForespoersel) |
...
| Term             | Kardinalitet |
| ---------------- | ------------ |
| [Person]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/Person) | 1..1000      |
