...
| Kilde         | DIFI |
| Kommentar     | Webservice response som Postkasseleverandør mottar fra Kontaktregisteret som svar på [SlettPostkasseForespoersel]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/SlettPostkasseForespoersel) |
