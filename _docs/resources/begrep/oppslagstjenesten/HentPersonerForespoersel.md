...
Responsen er en [HentPersonerRespons]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/HentPersonerRespons)

#### Attributer

| Term                                               | Kardinalitet |
| -------------------------------------------------- | ------------ |
| [personidentifikator]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/begrep/personidentifikator) | 1..1000      |
