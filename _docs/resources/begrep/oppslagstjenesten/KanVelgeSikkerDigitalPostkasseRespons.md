...
| Kilde         | DIFI |
| Kommentar     | Webservice response som Postkasseleverandør mottar fra Kontaktregisteret som svar på [KanVelgeSikkerDigitalPostkasseForespoersel]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/KanVelgeSikkerDigitalPostkasseForespoersel) |
