...
| Utvidelser: |                                                                       |
| xml     | [application/vnd.difi.dpi.bevis+xml]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/Utvidelser/Bevis)                      |
| xml     | [application/vnd.difi.dpi.lenke+xml]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/Utvidelser/Lenke)                      |
| xml     | [application/vnd.difi.dpi.arrangement+xml]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/Utvidelser/Arrangement)          |
