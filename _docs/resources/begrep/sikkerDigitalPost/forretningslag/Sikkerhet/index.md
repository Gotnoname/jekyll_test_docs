...
Dokumentpakken bør være signert av [Behandlingsansvarlig]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/Aktorer),
men kan signeres av [Databehandler]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/Aktorer).
