...
[Avsender]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/begrep/Avsender) til
...
[Meldingsformidlerleverandør]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/transportlag/UserMessage/PartyInfo), og fra
...
Følgende deler av Digital postforsendelse er sikret punkt til punkt:
  ...
  - [Webservice security timestamp]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/ws-security/WebserviceSecurity)
  - [Eb:messaging](ebMS30)
...
[StandardBusinessDocument.Melding.Avsender]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/begrep/Avsender)
...
### [Webservice Security]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/ws-security/WebserviceSecurity)
  ...
  - wsse:Secuity skal inneholde en signatur.
      - Denne signaturen skal ha referanse til følgende signerte
        elementer:
          - [Timestamp]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/ws-security/WebserviceSecurity)
          - [eb:Messaging](ebMS30)
          - [SOAP Body
            (StandardBusinessDocument)](StandardBusinessDocument/)
          - [Attachment (Dokumentpakke)](Dokumentpakke/)
  - Signeringssertifikatet skal være vedlagt SOAP meldingen i
    [wsse:security]({{site.baseurl}}/docs/resources/begrep/oppslagstjenesten/ws-security/WebserviceSecurity)
...
[Behandlingsansvarlig]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/Aktorer).  
