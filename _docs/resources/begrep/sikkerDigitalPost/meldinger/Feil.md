...
[Digitalpostmelding]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/DigitalpostMelding.png) og
[Dokumentpakken]({{site.baseurl}}/docs/resources/begrep/ID-porten/index).

Feilen må utbedres og ny [Digitalpostmelding]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/DigitalpostMelding.png) må
sendes.
...
| --- | --- |
| KLIENT | Feilen kommer pga. feil på input eller andre feil der [Avsender]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/begrep/Avsender) må rette opp i årsaken til feilen |
| SERVER | Feilen kommer av feil på sentral infrastruktur. [Avsender]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/begrep/Avsender) må ta kontakt med Sentralforvalter for å få rettet opp i feilen. |
