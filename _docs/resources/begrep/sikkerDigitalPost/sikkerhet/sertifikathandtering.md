...
(Disse sertifikatene må legges inn i truststore)
  ...
  - Fra Buypass:
    [Buypass\_Class\_3\_Test4\_Root\_CA]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/sikkerhet/sertifikater/test/Buypass_Class_3_Test4_Root_CA.cer)
...
(Disse må ligge i CertStore)
  ...
  - Fra Buypass:
    [Buypass\_Class\_3\_Test4\_CA\_3]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/sikkerhet/sertifikater/test/Buypass_Class_3_Test4_CA_3.cer)
