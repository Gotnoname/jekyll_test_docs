...
| --- | --- | --- |
| PMode.ID | Unik identifikator for paramtersettet | %[Sender]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/StandardBusinessDocument/Sender)%-"KvitteringsForespoersel"-%versjon/løpenummer%) |
