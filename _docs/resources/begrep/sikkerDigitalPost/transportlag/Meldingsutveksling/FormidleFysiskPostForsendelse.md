...
| --- | --- | --- |
| PMode.ID | Unik identifikator for paramtersettet | %[Sender]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/StandardBusinessDocument/Sender)%-"FormidleDigitalPostForsendelse"-%versjon/løpenummer%) |
...
| PMode.Initiator.Party | Identifikator for den som initierar sendingen | %[Sender]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/StandardBusinessDocument/Sender)% |
| PMode.Initiator.Role | Rolle for den som initierar sendinga | [”Avsender“]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/begrep/Avsender) |
...
| PMode.Responder.Party | Identifikator for den som er mottaker | %[Receiver]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/StandardBusinessDocument/Receiver)% |
...
| PMode\[1\].Security.X509.Signature.Certificate | %[Sender]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/forretningslag/StandardBusinessDocument/Sender) sitt sertifikat% |
...
### Eksempler
  ...
  - [request_forretningsmelding_fra_postavsender_til_meldingsformidler_fysisk_post]({{site.baseurl}}/docs/resources/begrep/sikkerDigitalPost/eksempler/soap/7_request_forretningsmelding_fra_postavsender_til_meldingsformidler_fysisk_post.xml)
