...
Om du skal sette opp integrasjonspunktet mot testmiljø kan en enten legge til ```spring.profiles.active=staging ``` i [integrasjonspunkt-local.properties-filen]({{site.baseurl}}/docs/resources/eformidling/integrasjonspunkt-local.txt) eller legge til ```-Dspring.profiles.active=staging``` som argument i XML-fila.
...
<!--
 [NextMove: Postman Arkivmelding DPO request]({{site.baseurl}}/docs/resources/eformidling/DPO.postman_collection.json)
-->
