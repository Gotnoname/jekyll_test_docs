...
2. Last ned konfigurasjonsfila vår for [testmiljø]({{site.baseurl}}/docs/resources/eformidling/integrasjonspunkt-staging.xml) eller [produksjonsmiljø]({{site.baseurl}}/docs/resources/eformidling/integrasjonspunkt-prod.xml) <!-- desse er korrekte URL'er til felleslosninger integrasjonspunkt 05.03.2020 -->
